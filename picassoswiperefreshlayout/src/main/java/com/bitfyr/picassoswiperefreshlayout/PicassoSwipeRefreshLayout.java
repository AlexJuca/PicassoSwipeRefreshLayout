...
/*
 * Copyright (C) 2016 Alexandre Juca corextechnologies@gmail.com
 *
...
public class PicassoSwipeRefreshLayout extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = PicassoSwipeRefreshLayout.class.getSimpleName();
     ...
     * @param context
     */
    public PicassoSwipeRefreshLayout(Context context) {
        this(context, null);
    }
