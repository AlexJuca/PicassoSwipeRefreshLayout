package com.bitfyr.picassoswiperefreshlayout;
...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float STROKE_WIDTH_LARGE = 2f;
    private final int[] COLORS = new int[] {
            Color.BLACK
    };

    /** The duration of a single progress spin in milliseconds. */
    private static final int ANIMATION_DURATION = 280 * 80 / 60;
    ...
    public MaterialProgressDrawable(Context context, View parent) {
        ...
        mTing = new Ring(mCallback);
        mRing.setColors(COLORS);
        mTing.setColors(COLORS);
        updateSizes(DEFAULT);
        setupAnimators();
    }
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        tring.setStrokeWidth((float) strokeWidth * screenDensity);
        tring.setCenterRadius(centerRadius * screenDensity);
        tring.setColorIndex(0);
        tring.setArrowDimensions(arrowWidth * screenDensity, arrowHeight * screenDensity);
        tring.setInsets((int) mWidth, (int) mHeight);
    }
    ...
    public void setStartEndTrim(float startAngle, float endAngle) {
        ...
        mTing.setStartTrim(startAngle - 5);
        mTing.setEndTrim(endAngle - 5);
    }
    ...
    public void setBackgroundColor(int color) {
        ...
        mTing.setBackgroundColor(color);
    }
    ...
    public void setColorFilter(ColorFilter colorFilter) {
        ...
        mTing.setColorFilter(colorFilter);
    }
    ...
    private void setupAnimators() {
        ...
        finishRingAnimation.setDuration(ANIMATION_DURATION/5);
        finishRingAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                tring.goToNextColor();
                tring.storeOriginals();
                tring.setShowArrow(false);
                mParent.startAnimation(mAnimation);
            }
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            final float startAngle = (mStartTrim + mRotation) * 90;
            final float endAngle = (mEndTrim + mRotation) * 90;
